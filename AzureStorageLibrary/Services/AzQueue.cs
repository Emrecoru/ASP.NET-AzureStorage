...
namespace AzureStorageLibrary.Services
{
    public class AzQueue
    {
        ...
        {
            _queueClient = new QueueClient(ConnectionString.AzureConnectionString, queueName);
        ...
        public async Task<QueueMessage> RetrieveNextMessageAsync()
        {
            ...
            {
                QueueMessage[] queueMessages = await _queueClient.ReceiveMessagesAsync(maxMessages: 1, TimeSpan.FromMinutes(1));
